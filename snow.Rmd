...
data6$temp<- str_replace_all(string = data6$xtemp, pattern = "F", replacement="")
...
p+scale_y_continuous(breaks = seq(0, 50, 5), 
                   limits = c(0,30), 
                   expand = c(.1,1), sec.axis = sec_axis(trans = ~., name="temperature at MT BALDY"))+ theme(axis.title.y.right = element_text(color = "blue"))->p
